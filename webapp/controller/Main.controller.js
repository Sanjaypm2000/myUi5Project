...
//call back which will get called when all dependencies are loaded
    function (BaseController,Model,NumberFormat, lifeSaver) {
        return BaseController.extend("mickey.controller.Main", {
            san:100, // Global variable can access by any function of a controller
            formatter: lifeSaver,
            //  oCore: sap.ui.getCore(), --present in nbase controller as global variable can be used for all other controllers
            anotherFx: function () {
...
// });
            ...
            onBeforeRendering: function(){
                ...
                // this.getView().byId("idSmk").setSelected(true);
